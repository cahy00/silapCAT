		...
		<div class="row">
			...
			<div class="col-12 col-sm-6 col-md-3">
				<div class="info-box mb-3">
					...
					<div class="info-box-content">
						<span class="info-box-text">Tipe Dokumen</span>
...
{{-- <script src="{{ $suratMasukChart->cdn() }}"></script>

{{ $suratMasukChart->script() }} --}}
<script src="https://code.highcharts.com/highcharts.js"></script>
<script type="text/javascript">
	// $(document).ready(function(){
	// 	var surat_masuk_bulanan = <?php echo json_encode($surat_masuk_bulanan); ?>;
	// 	var bulan = {{$bulan}}
