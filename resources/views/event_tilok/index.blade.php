		...
		<div class="row">
			<div class="col-12">
				<div class="card card-primary">
					...
					<!-- /.card-header -->
					<!-- form start -->
					<form action="/event-tilok/store" method="POST" enctype="multipart/form-data">
						@csrf()
						<div class="card-body">
							<div class="row">
								<div class="col-4">
									<div class="form-select">
										...
										<select name="event_id" id="" class="form-control" style="text-transform: uppercase;">
											@foreach ($event as $item)
												<option value="{{$item->id}}" style="text-transform: uppercase;">{{$item->name}}</option>
											@endforeach
										</select>
										@error('event_id')
								...
								<div class="col-4">
									<div class="form-group">
										...
										<select name="tilok_id" id="" class="form-control" style="text-transform: uppercase;">
											@foreach ($tilok as $item)
												<option value="{{$item->id}}" style="text-transform: uppercase;">{{$item->name}}</option>
											@endforeach
										</select>
										@error('tilok_id')
