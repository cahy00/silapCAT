...
class ListReports extends ListRecords
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            \Filament\Actions\Action::make('exportRecapExcel')
                ->label('Ekspor Rekap Excel')
                ->icon('heroicon-o-document-arrow-down')
                ->color('success')
                ->modalHeading('Ekspor Rekapitulasi Laporan Harian ke Excel (.XLSX)')
                ->modalDescription('Pilih filter kegiatan dan periode waktu untuk mengunduh rekapitulasi laporan harian dalam format Excel (.xlsx).')
                ...
                ->action(function (array $data) {
                    ...
                    $url = route('reports.recap-excel', $params);
                    return redirect()->to($url);
                }),
            CreateAction::make(),
        ];
